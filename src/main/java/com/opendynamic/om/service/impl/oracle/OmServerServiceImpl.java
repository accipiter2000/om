...
public class OmServerServiceImpl implements OmServerService {
    @Autowired
    ...
    @Override
    public int pushCopyMirrorServerOrgnSet(String MIRROR_SERVER_ID_, final String ORGN_SET_ID_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        DataSource mirrorServerDataSource = getMirrorServerDataSource(omMirrorServerService.loadMirrorServer(MIRROR_SERVER_ID_));
        JdbcTemplate mirrorServerJdbcTemplate = new JdbcTemplate(mirrorServerDataSource);
        String sql;
        BatchPreparedStatementSetter batch;

        mirrorServerJdbcTemplate.execute("alter table OM_ORG disable constraint FK_OM_ORG_PARENT");

        DataSourceTransactionManager transactionManager = new DataSourceTransactionManager(mirrorServerDataSource);
        TransactionStatus transactionStatus = transactionManager.getTransaction(new DefaultTransactionDefinition());

        try {
            sql = "delete from OM_TAG where ORGN_SET_ID_ = ?";
            mirrorServerJdbcTemplate.update(sql, ORGN_SET_ID_);
            ...
            List<Map<String, Object>> orgnSetList = mirrorServerJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
            if (orgnSetList.size() == 0) {// 如果没有ORGN_SET，新增一个。并计算其PARENT_ORGN_SET_ID_
                String PARENT_ORGN_SET_ID_ = null;
                Map<String, Object> orgnSet = omOrgnSetService.loadOrgnSet(ORGN_SET_ID_, OPERATOR_ID_, OPERATOR_NAME_);
                if (orgnSet.get("PARENT_ORGN_SET_ID_") != null) {
                    if (mirrorServerJdbcTemplate.queryForList(sql, orgnSet.get("PARENT_ORGN_SET_ID_")).size() > 0) {
                ...
                mirrorServerJdbcTemplate.update(sql, ORGN_SET_ID_, PARENT_ORGN_SET_ID_, orgnSet.get("ORGN_SET_CODE_"), orgnSet.get("ORGN_SET_NAME_"), orgnSet.get("ALLOW_SYNC_"), orgnSet.get("MEMO_"), orgnSet.get("ORDER_"), orgnSet.get("ORGN_SET_STATUS_"), orgnSet.get("CREATION_DATE_"), orgnSet.get("UPDATE_DATE_"), orgnSet.get("OPERATOR_ID_"), orgnSet.get("OPERATOR_NAME_"));
            }
            ...
            final List<Map<String, Object>> tagList = omJdbcTemplate.queryForList("select * from OM_TAG where ORGN_SET_ID_ = ?", ORGN_SET_ID_);
            ...
            mirrorServerJdbcTemplate.execute("alter table OM_ORG enable constraint FK_OM_ORG_PARENT");
        }
        catch (Exception e) {
    ...
    public OrgnChange pushCompareMirrorServerOrgnSet(String MIRROR_SERVER_ID_, String ORGN_SET_ID_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        ...
        JdbcTemplate mirrorServerJdbcTemplate = new JdbcTemplate(getMirrorServerDataSource(omMirrorServerService.loadMirrorServer(MIRROR_SERVER_ID_)));
        String sql;
        ...
        List<Map<String, Object>> orgList = omJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        List<Map<String, Object>> mirrorServerOrgList = mirrorServerJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        ...
        List<Map<String, Object>> dutyList = omJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        List<Map<String, Object>> mirrorServerDutyList = mirrorServerJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        ...
        List<Map<String, Object>> posiList = omJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        List<Map<String, Object>> mirrorServerPosiList = mirrorServerJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        ...
        List<Map<String, Object>> empList = omJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        List<Map<String, Object>> mirrorServerEmpList = mirrorServerJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        ...
        List<Map<String, Object>> posiEmpList = omJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        List<Map<String, Object>> mirrorServerPosiEmpList = mirrorServerJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        ...
        List<Map<String, Object>> empRelationList = omJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
        List<Map<String, Object>> mirrorServerEmpRelationList = mirrorServerJdbcTemplate.queryForList(sql, ORGN_SET_ID_);
    ...
    public int pushReplaceMirrorServerOrgnSet(String MIRROR_SERVER_ID_, final String ORGN_SET_ID_, List<String> INSERT_ORG_ID_LIST, List<String> UPDATE_ORG_ID_LIST, List<String> DELETE_ORG_ID_LIST, List<String> INSERT_DUTY_ID_LIST, List<String> UPDATE_DUTY_ID_LIST, List<String> DELETE_DUTY_ID_LIST, List<String> INSERT_POSI_ID_LIST, List<String> UPDATE_POSI_ID_LIST, List<String> DELETE_POSI_ID_LIST, List<String> INSERT_EMP_ID_LIST, List<String> UPDATE_EMP_ID_LIST, List<String> DELETE_EMP_ID_LIST, List<String> INSERT_POSI_EMP_ID_LIST, List<String> UPDATE_POSI_EMP_ID_LIST, List<String> DELETE_POSI_EMP_ID_LIST, List<String> INSERT_EMP_RELATION_ID_LIST, List<String> UPDATE_EMP_RELATION_ID_LIST, List<String> DELETE_EMP_RELATION_ID_LIST, Date UPDATE_DATE_, String OPERATOR_ID_,
        ...
        String sql;
        BatchPreparedStatementSetter batch;
        NamedParameterJdbcTemplate namedParameterMirrorServerJdbcTemplate = new NamedParameterJdbcTemplate(mirrorServerJdbcTemplate);
        ...
        try {
            ...
            selectTagSql += ")";
            if (OBJ_ID_LIST.size() > 0) {
                final List<Map<String, Object>> tagList = new NamedParameterJdbcTemplate(omJdbcTemplate).queryForList(selectTagSql, selectTagParamMap);
                sql = "insert into OM_TAG (ORGN_SET_ID_, TAG_ID_, OBJ_ID_, OBJ_TYPE_, TAG_) values (?, ?, ?, ?, ?)";
                batch = new BatchPreparedStatementSetter() {
                    public void setValues(PreparedStatement ps, int i) throws SQLException {
                        Map<String, Object> tag = tagList.get(i);
    ...
    public List<Map<String, Object>> selectMirrorServerOrgnSet(String MIRROR_SERVER_ID_, String ORGN_SET_ID_, String PARENT_ORGN_SET_ID_, String ORGN_SET_CODE_, String ORGN_SET_NAME_, List<String> ORGN_SET_STATUS_LIST, Boolean rootOnly, Integer page, Integer limit, String OPERATOR_ID_, String OPERATOR_NAME_) {
        OdSqlCriteria odSqlCriteria = buildSqlCriteriaMirrorServerOrgnSet(false, MIRROR_SERVER_ID_, ORGN_SET_ID_, PARENT_ORGN_SET_ID_, ORGN_SET_CODE_, ORGN_SET_NAME_, ORGN_SET_STATUS_LIST, rootOnly, OPERATOR_ID_, OPERATOR_NAME_);// 根据查询条件组装查询SQL语句
        ...
        DataSource mirrorServerDataSource = getMirrorServerDataSource(omMirrorServerService.loadMirrorServer(MIRROR_SERVER_ID_));
        NamedParameterJdbcTemplate namedParameterJdbcTemplate = new NamedParameterJdbcTemplate(mirrorServerDataSource);
    ...
    public int countMirrorServerOrgnSet(String MIRROR_SERVER_ID_, String ORGN_SET_ID_, String PARENT_ORGN_SET_ID_, String ORGN_SET_CODE_, String ORGN_SET_NAME_, List<String> ORGN_SET_STATUS_LIST, Boolean rootOnly, String OPERATOR_ID_, String OPERATOR_NAME_) {
        OdSqlCriteria odSqlCriteria = buildSqlCriteriaMirrorServerOrgnSet(true, MIRROR_SERVER_ID_, ORGN_SET_ID_, PARENT_ORGN_SET_ID_, ORGN_SET_CODE_, ORGN_SET_NAME_, ORGN_SET_STATUS_LIST, rootOnly, OPERATOR_ID_, OPERATOR_NAME_);// 根据查询条件组装总数查询SQL语句
        String sql = odSqlCriteria.getSql();
        Map<String, Object> paramMap = odSqlCriteria.getParamMap();
    ...
    private OdSqlCriteria buildSqlCriteriaMirrorServerOrgnSet(boolean count, String MIRROR_SERVER_ID_, String ORGN_SET_ID_, String PARENT_ORGN_SET_ID_, String ORGN_SET_CODE_, String ORGN_SET_NAME_, List<String> ORGN_SET_STATUS_LIST, Boolean rootOnly, String OPERATOR_ID_, String OPERATOR_NAME_) {// 组装查询SQL语句
        String sql;
    ...
    private DataSource getMirrorServerDataSource(Map<String, Object> mirrorServer) {
        BasicDataSource dataSource = new BasicDataSource();
        dataSource.setDriverClassName((String) mirrorServer.get("DRIVER_CLASS_NAME_"));
        dataSource.setUrl((String) mirrorServer.get("URL_"));
        dataSource.setUsername((String) mirrorServer.get("USERNAME_"));
        dataSource.setPassword((String) mirrorServer.get("PASSWORD_"));
