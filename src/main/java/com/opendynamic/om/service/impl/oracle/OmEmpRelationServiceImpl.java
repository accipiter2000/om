...
public class OmEmpRelationServiceImpl implements OmEmpRelationService {
    ...
    public int insertEmpRelation(String ORGN_SET_ID_, String EMP_RELATION_ID_, String UPPER_EMP_ID_, String LOWER_EMP_ID_, String EMP_RELATION_, String EMP_RELATION_TAG_, String EMP_RELATION_STATUS_, Date CREATION_DATE_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        ...
        String sql = "insert into OM_EMP_RELATION (ORGN_SET_ID_, EMP_RELATION_ID_, UPPER_EMP_ID_, LOWER_EMP_ID_, EMP_RELATION_, EMP_RELATION_TAG_, EMP_RELATION_STATUS_, CREATION_DATE_, UPDATE_DATE_, OPERATOR_ID_, OPERATOR_NAME_) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public int updateEmpRelation(String ORGN_SET_ID_, String EMP_RELATION_ID_, String EMP_RELATION_, String EMP_RELATION_TAG_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        ...
        String sql = "update OM_EMP_RELATION set EMP_RELATION_ = ?, EMP_RELATION_TAG_ = ?, UPDATE_DATE_ = ?, OPERATOR_ID_ = ?, OPERATOR_NAME_ = ? where ORGN_SET_ID_ = ? and EMP_RELATION_ID_ = ?";
    ...
    public int deleteEmpRelationByEmpId(String ORGN_SET_ID_, String EMP_ID_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        ...
        List<Map<String, Object>> upperEmpRelationList = selectEmpRelation(ORGN_SET_ID_, null, null, EMP_ID_, null, null, null, null, null, 1, -1, OPERATOR_ID_, OPERATOR_NAME_);
        ...
        List<Map<String, Object>> lowerEmpRelationList = selectEmpRelation(ORGN_SET_ID_, null, null, null, EMP_ID_, null, null, null, null, 1, -1, OPERATOR_ID_, OPERATOR_NAME_);
